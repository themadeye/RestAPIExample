...
public class RestAuthenticationClient {
     ...
     */
    public RestAuthenticationClient(String  baseUrl, String username, String password) {
        setBaseUrl(baseUrl);
     ...
     * @return this
     */
    public RestAuthenticationClient setBaseUrl(String baseUrl) {
     ...
     * @return this
     */
    public RestAuthenticationClient setUrlResource(String urlResource) {
     ...
     * @return this
     */
    public final RestAuthenticationClient setUrlPath(String urlPath) {
     ...
     * @return this
     */
    public RestAuthenticationClient setHttpMethod(String httpMethod) {
     ...
     * @return this
     */
    public RestAuthenticationClient setParameters(HashMap<String, String> parameters) {
     ...
     * @return this
     */
    public RestAuthenticationClient setParameter(String key, String value) {
     ...
     * @return this
     */
    public RestAuthenticationClient clearParameters() {
     ...
     */
    public RestAuthenticationClient removeParameter(String key) {
     ...
     * @return this
     */
    public RestAuthenticationClient clearAll() {
        parameters.clear();
        baseUrl = "";
        this.username = "";
        this.password = "";
